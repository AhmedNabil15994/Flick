...
@section('title', __('influencer::dashboard.influencers.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('influencer::dashboard.influencers.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                           'url'=> route('dashboard.influencers.store'),
                           'id'=>'form',
                           'role'=>'form',
                           'method'=>'POST',
