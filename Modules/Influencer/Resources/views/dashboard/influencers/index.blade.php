...
@section('title', __('influencer::dashboard.influencers.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('influencer::dashboard.influencers.routes.index') }}</a>
                    </li>
                </ul>
            </div>
                        ...
                        @can('add_influencers')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.influencers.create')) }}" class="btn sbold green">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="tags[]" multiple class="select2-ajax-tags select2 select2-mult" data-allow-clear="true" style="width: 100%">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('influencer::dashboard.influencers.datatable.tags') }}</th>
                                        <th>{{ __('influencer::dashboard.influencers.datatable.status') }}</th>
                                        ...
                                        <th>{{ __('influencer::dashboard.influencers.datatable.created_at') }}</th>
                                        <th data-priority="1">{{ __('influencer::dashboard.influencers.datatable.options') }}
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                    onclick="deleteAllChecked('{{ url(route('dashboard.influencers.deletes')) }}')">
...
@section('scripts')
   ...
   function tableGenerate(data='') {
     var exportbuttons = []
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.influencers.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columns: [
            ...
            {data: 'tags' 	 ,  orderable: false      , className: 'dt-center'},
          ...
          columnDefs: [
...

            {
              ...
              render: function(data, type, full, meta) {
                ...
                // Edit
      					var editUrl = '{{ route("dashboard.influencers.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

                          var showUrl = '{{ route("dashboard.influencers.show", ":id") }}';
      					showUrl = showUrl.replace(':id', data);


      					// Delete
      					var deleteUrl = '{{ route("dashboard.influencers.destroy", ":id") }}';
      					deleteUrl = deleteUrl.replace(':id', data);

      			 		return `
                       @can('edit_influencers')
  ...
  jQuery(document).ready(function() {
    ...
    $(".select2-ajax-tags").select2({
                ajax: {
                    url: "{{ route('dashboard.tags.show.options') }}",
