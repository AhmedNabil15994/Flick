...
{!! field()->text('user_name', __('influencer::dashboard.youtube.form.user_name')) !!}
{!! field()->text('account_id', __('influencer::dashboard.youtube.form.account_id')) !!}
{!! field()->text('url', __('influencer::dashboard.youtube.form.url')) !!}



{!! field()->checkBox('status', __('influencer::dashboard.youtube.form.status')) !!}
