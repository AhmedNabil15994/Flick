...
@section('title', __('influencer::dashboard.instagram.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('influencer::dashboard.instagram.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                           'url'=> route('dashboard.instagram.store'),
                           'id'=>'form',
                           'role'=>'form',
                           'method'=>'POST',
