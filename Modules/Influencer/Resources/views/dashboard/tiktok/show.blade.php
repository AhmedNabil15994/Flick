...
@section('title', __('influencer::dashboard.tiktok.routes.show'))
@section('css')
    <style>
        @media print {
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ url(route('dashboard.tiktok.index')) }}">
                            {{ __('influencer::dashboard.tiktok.routes.index') }}
                        </a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="#">{{ __('influencer::dashboard.tiktok.routes.show') }} -
                            {{ $model->user_name }}</a>
                    </li>
                </ul>
            </div>
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li
                                                ...
                                                <a href="#general" data-toggle="tab">
                                                    {{ __('influencer::dashboard.tiktok.form.tabs.general') }}
                                                </a>
                                            </li>

                                            <li class="{{ request()->tab == 'statistic' ? 'active' : '' }}">
                                                <a href="#statistic" data-toggle="tab">
                                                    {{ __('influencer::dashboard.tiktok.form.tabs.statistic') }}
                                                </a>
                                            </li>
                            ...
                            <div id="general">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th>
                                                {{ __('influencer::dashboard.tiktok.datatable.user_name') }}
                                            </th>
                                            <td>
                                                {{ $model->user_name }}
                                            </td>
                                        ...
                                        <tr>
                                            <th>
                                                {{ __('influencer::dashboard.tiktok.datatable.account_id') }}
                                            </th>
                                            <td>
                                                {{ $model->account_id }}
                                            </td>
                                        ...
                                        <tr>
                                            <th class="invoice-title uppercase" style="width: 200px">
                                                {{ __('influencer::dashboard.tiktok.datatable.created_at') }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="invoice-title uppercase" style="width: 200px">
                                                {{ __('influencer::dashboard.tiktok.datatable.latest_calling_at') }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="invoice-title uppercase" style="width: 200px">
                                                {{ __('influencer::dashboard.tiktok.datatable.status') }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>
                                                {{ __('influencer::dashboard.tiktok.form.is_verified') }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>
                                                {{ __('influencer::dashboard.tiktok.form.is_hidden') }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>
                                                {{ __('influencer::dashboard.tiktok.form.api_info') }}
                                            </th>
                                            <td>
                                                @if ($model->api_info)
                                                    <div>
                                                ...
                                                <div>
                                                    <form method="POST"
                                                        action="{{ route('dashboard.tiktok.show.update_stat', $model->id) }}">
                                                        @csrf
                            ...
                            <div id="statistic">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.avg_likes') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.avg_comments') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.posts_count') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 red-flamingo" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.engagements') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 red-haze" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.engagement_rate') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-haze" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.followers') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-meadow" href="#">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.avg_views') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-meadow" href="#">
                                            ...
                                            <div class="details">
                                                <div class="number">
                                                    <span data-counter="counterup"
                                                        data-value="{{ $model->total_likes ?? 0 }}">0</span>
                                                </div>
                                                <div class="desc">
                                                    {{ __('influencer::dashboard.tiktok.form.total_likes') }}
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <b class="page-title">
                                            {{ __('influencer::dashboard.tiktok.form.audience_genders') }}
                                        </b>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <b class="page-title">
                                            {{ __('influencer::dashboard.tiktok.form.audience_ages') }}
                                        </b>
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <b class="page-title">
                                            {{ __('influencer::dashboard.tiktok.form.audience_genders_per_age') }}
                                        </b>
                                    ...
                                    <div class="col-md-4">
                                        <b class="page-title">
                                            {{ __('influencer::dashboard.tiktok.form.stat_history') }}
                                        </b>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <canvas id="stat_history_avg" height="300" class="mb-3"></canvas>
                                    </div>

                                    <div class="col-md-4">
                                        <b class="page-title">
                                            {{ __('influencer::dashboard.tiktok.form.audience_reachability') }}
                                        </b>
                                        <canvas id="audience_reachability" height="300" class="mb-3"></canvas>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-actions">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ url(route('dashboard.tiktok.index')) }}" class="btn btn-lg red">
        ...
        $(function() {
            ...
            var statHistoryData = {
                datasets: [
                    ...
                    {
                        label: "Total Likes",
                        data: @json(Arr::pluck($model->stat_history ?? [], 'total_likes')),
                        backgroundColor: generateRandomColor()
                    }
                ],
            ...
            // stat_historya
            var statHistoryDataLabelAvg = @json(Arr::pluck($model->stat_history ?? [], 'month'));

            var statHistoryDataAvg = {
                datasets: [
                    {
                        label: "Avg Like",
                        data: @json(Arr::pluck($model->stat_history ?? [], 'avg_likes')),
                ...
                // These labels appear in the legend and in the tooltips when hovering different arcs
                labels: statHistoryDataLabelAvg
            }
            new Chart(document.getElementById("stat_history_avg"), {
                type: 'bar',
                data: statHistoryDataAvg,
                options: {
                    legend: {
                        position: 'bottom'
                    }
            ...
            var audience_reachability = {
                datasets: [{
                    data: @json(Arr::pluck($model->audience_reachability ?? [], 'weight')),
                    backgroundColor: generateColorArray(4)
                }],

                // These labels appear in the legend and in the tooltips when hovering different arcs
                labels: @json(Arr::pluck($model->audience_reachability ?? [], 'code'))
            }
            new Chart(document.getElementById("audience_reachability"), {
                type: 'doughnut',
                data: audience_reachability,
                options: {
                    legend: {
                        position: 'bottom'
                    }
