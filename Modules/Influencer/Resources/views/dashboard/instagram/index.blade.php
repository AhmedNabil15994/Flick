...
@section('title', __('influencer::dashboard.instagram.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('influencer::dashboard.instagram.routes.index') }}</a>
                    </li>
                </ul>
            </div>
                        ...
                        @can('add_instagram')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.instagram.create')) }}" class="btn sbold green">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.influencer_id') }}</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.user_name') }}</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.account_id') }}</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.latest_calling_at') }}</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.status') }}</th>
                                        <th>{{ __('influencer::dashboard.instagram.datatable.created_at') }}</th>
                                        <th data-priority="1">{{ __('influencer::dashboard.instagram.datatable.options') }}
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                    onclick="deleteAllChecked('{{ url(route('dashboard.instagram.deletes')) }}')">
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.instagram.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columnDefs: [
...

            {
              targets: -1,
              width: '13%',
              title: '{{__('influencer::dashboard.instagram.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.instagram.edit", ":id") }}';
      					...
      					// Delete
      					var deleteUrl = '{{ route("dashboard.instagram.destroy", ":id") }}';
