...
{!! field()->text('user_name', __('influencer::dashboard.instagram.form.user_name')) !!}
{!! field()->text('account_id', __('influencer::dashboard.instagram.form.account_id')) !!}
{!! field()->text('url', __('influencer::dashboard.instagram.form.url')) !!}




{!! field()->checkBox('status', __('influencer::dashboard.instagram.form.status')) !!}
