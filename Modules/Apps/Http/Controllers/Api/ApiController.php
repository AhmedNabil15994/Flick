...
class ApiController extends Controller
{
    ...
    public function responsePagination($pagination, $data=[], $message = 'Successfully')
    {
        $addition = array_merge(['success' => true, "message"=> $message], $data);
        return $pagination->additional($addition);
    }
