...
{!! field()->text('user_name', __('influencer::dashboard.twitch.form.user_name')) !!}
{!! field()->text('account_id', __('influencer::dashboard.twitch.form.account_id')) !!}


{!! field()->checkBox('status', __('influencer::dashboard.twitch.form.status')) !!}
