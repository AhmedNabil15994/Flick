...
@section('title', __('company::dashboard.companies.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('company::dashboard.companies.routes.index') }}</a>
                    </li>
                </ul>
            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th class="all">{{ __('company::dashboard.companies.datatable.logo') }}</th>
                                        <th class="all">{{ __('company::dashboard.companies.datatable.name') }}</th>
                                        <th class="all">{{ __('company::dashboard.companies.datatable.description') }}</th>
                                        <th>{{ __('company::dashboard.companies.datatable.manager_id') }}</th>
                                        <th>{{ __('company::dashboard.companies.datatable.status') }}</th>
                                        <th>{{ __('company::dashboard.companies.datatable.mobile') }}</th>
                                        <th>{{ __('company::dashboard.companies.datatable.email') }}</th>
                                        <th>{{ __('company::dashboard.companies.datatable.created_at') }}</th>
                                        <th data-priority="1">{{ __('company::dashboard.companies.datatable.options') }}
                                        </th>
                                    </tr>
                                </thead>
                            </table>
      ...
      $('#dataTable').DataTable({
          ...
          columns: [
            {data: 'id' 		 	        , className: 'dt-center'},
      		{data: 'id' 		 	        , className: 'dt-center'},
            { data: "logo" ,orderable: false , width: "1%",
            ...
            {data: 'manager_id' 	        , className: 'dt-center' ,},
          ...
          columnDefs: [
...

            {
              targets: -1,
              width: '13%',
              title: '{{__('company::dashboard.companies.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
