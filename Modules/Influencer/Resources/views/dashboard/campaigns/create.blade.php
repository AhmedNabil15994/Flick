...
@section('title', __('influencer::dashboard.campaigns.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('influencer::dashboard.campaigns.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            {!! Form::model($model,[
                           'url'=> route('dashboard.campaigns.store'),
                           'id'=>'form',
                           'role'=>'form',
                           'method'=>'POST',
