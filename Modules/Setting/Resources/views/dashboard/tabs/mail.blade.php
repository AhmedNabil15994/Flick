<div class="tab-pane fade" id="mail">
    ...
    <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="env[MAIL_FROM_ADDRESS]" value="{{env('MAIL_FROM_ADDRESS')}}" autocomplete="off" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="env[MAIL_USERNAME]" value="{{env('MAIL_USERNAME')}}" autocomplete="off" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2">
