                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('slider::dashboard.sliders.datatable.title')}}</th>
                                    <th>{{__('slider::dashboard.sliders.datatable.description')}}</th>
                                    <th>{{__('slider::dashboard.sliders.datatable.type')}}</th>
                                    <th>{{__('slider::dashboard.sliders.datatable.status')}}</th>
