...
class UserRepository
{
    ...
    {
        return $this->user->baseType(UserType::USER)->orderBy('id', 'DESC')->get();
    }

    public function getAllActive()
    {
        return $this->user->baseType(UserType::USER)->select("id", "name")->orderBy('id', 'DESC')->get();
    }
    ...
    {
        $users = $this->user->baseType(UserType::USER)->count();
    ...
    */
    ...
    {
        $users = $this->user->baseType(UserType::USER)->orderBy($order, $sort)->get();
        return $users;
    }
    ...
    */
    public function QueryTable($request)
    {
        ...
        ->where('id', '!=', auth()->id())->baseType(UserType::USER)->withDeleted()
        ;
