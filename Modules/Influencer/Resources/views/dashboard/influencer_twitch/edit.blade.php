...
@section('title', __('influencer::dashboard.influencer_twitch.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('influencer::dashboard.influencer_twitch.routes.update') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                {!! Form::model($model, [
                    'url' => route('dashboard.influencer_twitch.update', $model->id),
                    'id' => 'updateForm',
                    'role' => 'form',
                    'page' => 'form',
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <div class="col-md-10">
                                    ...
                                    @include('influencer::dashboard.influencer_twitch.form')
                            ...
                            <div class="tab-pane  fade in" id="statistic">
                                <div class="col-md-10">
                                    ...
                                    @include('influencer::dashboard.influencer_twitch.statistic')
