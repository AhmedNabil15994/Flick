                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{__('authorization::dashboard.roles.form.type')}}
                                            </label>
                                            <div class="col-md-9">
                                                <select class="form-control select2"  name="type" data-name="type">
                                                    @foreach (\Modules\Authorization\Enum\RoleType::getConstList() as $item)
                                                        <option value="{{$item}}" {{$role->type == $item ? "selected" : ''}}>
                                                            @lang("authorization::dashboard.roles.form.types.".$item)
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <div class="help-block"></div>
