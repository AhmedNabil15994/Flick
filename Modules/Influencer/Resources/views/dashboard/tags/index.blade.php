...
@section('title', __('influencer::dashboard.tags.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ __('influencer::dashboard.tags.routes.index') }}</a>
                    </li>
                </ul>
            </div>
                        ...
                        @can('add_tags')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.tags.create')) }}" class="btn sbold green">
                        ...
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">
                                    {{ __('influencer::dashboard.tags.routes.index') }}
                                </span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>{{ __('influencer::dashboard.tags.datatable.title') }}</th>
                                        <th>{{ __('influencer::dashboard.tags.datatable.description') }}</th>
                                        <th>{{ __('influencer::dashboard.tags.datatable.status') }}</th>
                                        <th>{{ __('influencer::dashboard.tags.datatable.created_at') }}</th>
                                        <th data-priority="1">{{ __('influencer::dashboard.tags.datatable.options') }}
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                    onclick="deleteAllChecked('{{ url(route('dashboard.tags.deletes')) }}')">
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.tags.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columnDefs: [
...

            {
              targets: -1,
              width: '13%',
              title: '{{__('influencer::dashboard.tags.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.tags.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.tags.destroy", ":id") }}';
